# Melhorias já publicadas (histórico)

> Arquivo de ARQUIVO. Registro do que já foi publicado em produção — separado de
> `MELHORIAS-PENDENTES.md` para não pesar o contexto de cada sessão. Uso apenas
> para consulta histórica; a fonte da verdade do código é o **git**.
> Separado de `MELHORIAS-PENDENTES.md` em 02/09/2026 (sistema já na v1.26.0).
