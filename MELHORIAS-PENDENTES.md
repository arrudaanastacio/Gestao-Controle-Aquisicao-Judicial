...
| 17 | Módulo Distribuição (novo) — importa automaticamente 4 planilhas do GSNET/IBL via vigia de pasta (Status de Faturas, Extrato de Movimentações, Itens Elegíveis CEDMAC, Conversão OD geral) e calcula a Sugestão de Reposição pra CEDMAC: `(3 × Consumo Mensal) − (Estoque convertido + Fatura em Trânsito)`, com linhas convertidas destacadas visualmente. Testado ponta a ponta com dados reais (9 itens da CEDMAC, incluindo os 3 com conversão). **Ainda falta**: configurar o Código Destino do GSNET para as demais unidades de Outras Demandas (só a CEDMAC está pronta — o vínculo entre Estoque/SCODES e Fatura/GSNET não dá pra fazer por nome, precisa desse código) | `307a34e`, `6add953`, `106c699`, `68f6819`, `5560bda` | 15/07/2026 | Pendente — CEDMAC pronta, demais unidades aguardando códigos |
