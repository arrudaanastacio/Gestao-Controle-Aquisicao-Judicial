...
| 17 | Módulo Distribuição (novo) — importa automaticamente 3 planilhas do GSNET/IBL via vigia de pasta: Status de Faturas + Extrato de Movimentações (testado com dados reais: 2.791 faturas, 98,9% com código SCODES) e Itens Elegíveis por unidade (exceção CEDMAC — Código, Consumo Mensal fixo por acordo administrativo, fator de Conversão; testado com 9 itens reais). Ainda falta: a tela de cálculo de sugestão de reposição, cruzando estoque + consumo + fatura em trânsito + conversão (próxima etapa) | `307a34e`, `6add953`, `106c699` | 15/07/2026 | Pendente — módulo parcial |
