...
| 3 | Estoque GSNET/IBL — nova tela cruzando GSNET + IBL (operador logístico) com o código SCODES, comparativo de saldo entre os dois sistemas, aba "Consolidado por Item" e aba "Controle de Validade" (lotes por faixa de vencimento). Corrigido: pasta de origem tinha mudado de lugar (agora `BANCO DE DADOS\RELATÓRIOS`, arquivos `3.Cadastro Itens GSNET - IBL.xlsx`, `4.Estoque GSNET.xlsx`, `5.Estoque IBL.xlsx`) e a coluna do código GSNET no cadastro também mudou de posição — testado com os arquivos reais, 97,4% dos itens resolvendo o código SCODES | `6264bbd`, `2be920a`, `d4cdc4d`, `9e1d2e4`, `503f13e`, `4ee5848` | 15/07/2026 | Pendente |
