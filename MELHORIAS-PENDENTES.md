...
| 17 | Módulo Distribuição (novo, completo) — importa automaticamente 5 planilhas do GSNET/IBL via vigia de pasta (Status de Faturas, Extrato de Movimentações, Itens Elegíveis CEDMAC, Conversão OD geral, Locais de Entrega) e calcula a Sugestão de Reposição para **qualquer unidade de Outras Demandas** (37 unidades disponíveis): `(3 × Consumo Mensal) − (Estoque convertido + Fatura em Trânsito)`, com linhas convertidas destacadas visualmente. O vínculo entre estoque (SCODES) e fatura em trânsito (GSNET) usa o código numérico do Locais de Entrega, já que os dois sistemas grafam a unidade de forma diferente. Testado ponta a ponta com dados reais: CEDMAC (elenco fechado, 9 itens) e Barretos (regra geral, 174 itens elegíveis, incluindo os com conversão) | `307a34e`, `6add953`, `106c699`, `68f6819`, `5560bda`, `7ba7bdd` | 15/07/2026 | Pendente |
