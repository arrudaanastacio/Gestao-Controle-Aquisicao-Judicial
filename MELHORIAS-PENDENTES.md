...
| 17 | Módulo Distribuição (novo) — importa automaticamente 2 planilhas do GSNET/IBL (Status de Faturas + Extrato de Movimentações) via vigia de pasta, traduz o código do item pro código SCODES, mostra em 2 abas com filtros. Testado com os arquivos reais da rede: 2.791 faturas, 98,9% com código SCODES resolvido. Ainda falta: lista de itens elegíveis da CEDMAC (aguardando Rafael) e o cálculo de sugestão de reposição (próxima etapa). **Atenção**: descobri que a pasta de rede do Estoque OD mudou de estrutura (virou pastas por mês) e o cadastro de mapeamento GSNET-IBL mudou de coluna — o Estoque GSNET/IBL já em produção pode estar lendo a coluna errada hoje, precisa verificar | `307a34e`, `6add953` | 15/07/2026 | Pendente — módulo parcial |
