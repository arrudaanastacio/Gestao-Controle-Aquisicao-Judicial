...
| 17 | Módulo Distribuição (novo) — importa automaticamente 4 planilhas do GSNET/IBL via vigia de pasta: Status de Faturas + Extrato de Movimentações (2.791 faturas, 98,9% com código SCODES), Itens Elegíveis CEDMAC (Consumo Mensal fixo por acordo administrativo + Conversão, 9 itens) e Conversão OD geral (vale pra qualquer unidade, 7 itens) — todos testados com arquivos reais. Ainda falta: a tela de cálculo de sugestão de reposição, cruzando estoque + consumo + fatura em trânsito + conversão (próxima etapa) | `307a34e`, `6add953`, `106c699`, `68f6819` | 15/07/2026 | Pendente — módulo parcial |
